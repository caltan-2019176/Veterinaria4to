...
/**
 *JInternalFrame para agregar mascota 
 * @author Carlos Altán
 * @version 1.0
 */
public class VistaAgregarMascota extends javax.swing.JInternalFrame {
    ...
    /**
     * Action performed de Jbutton 1 para agregar mascota 
     * @param evt 
     */
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        VistaMascota mascota = new VistaMascota(); 
        try{
            String dueno= jTextField1.getText(); 
            String nombre = jTextField2.getText();
            String idPersona = jTextField3.getText(); 
            String tipo = jTextField4.getText(); 
            String raza = jTextField5.getText(); 
            int edad = Integer.parseInt(jTextField6.getText() ); 
            String razonDeCita = jTextField7.getText();
            mascota.agregarMascota(nombre, dueno, idPersona, tipo, raza, edad, razonDeCita);
